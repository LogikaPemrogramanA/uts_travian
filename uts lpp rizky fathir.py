...
#pilih puak
    if id_2 == id_1 and password_2 == password_1 :
        ...
        if choose_puak == puak_trav[0] :
            ...
            jumlah_pengikut_1 = input('How many Imperians? :')
            jumlah_pengikut_2 = input('How many Equites Cesaeris? :')
            if int(banyak_tentara_1) > 100 or int(banyak_tentara_2) > 100 :
                print('Too much soldier you can deploy!')
                return log_in()
            else :
                total_attack = jumlah_pengikut_1 * (roma_attack[0] + (0.75 * roma_agility[0])) +  jumlah_pengikut_2 * (roma_attack[1] + (0.75 * roma_agility[1]))
                print(total_attack)
                ...
                if choose_enemy == puak_trav[0] :
                    ...
                    if serang == 'SERANG' :
                        ...
                        if pemenang > 0 :
                            ...
                            print('Puak : Romans')
                            print('TROOPS')
                            print('Imperian : ', jumlah_pengikut_1)
                            print('Equites Cecaris : ', jumlah_pengikut_2)
                    ...
                    if serang == 'SERANG' :
                        ...
                        if pemenang > 0 :
                            ...
                            print('Puak : Galia')
                            print('TROOPS')
                            print('Swordman : ', jumlah_pengikut_1)
                            print('Theutaes Thunder: ', jumlah_pengikut_2)
                            print('Total attack : ', total_attack)
                            print('Total defend : ', total_defend)
                            print('Total kemenangan : ', round(total_attack/total_defend))
                        else :
                    ...
                    if serang == 'SERANG' :
                        ...
                        if pemenang > 0 :
                            ...
                            print('Puak : Vikings')
                            print('TROOPS')
                            print('Clubswinger : ', jumlah_pengikut_1)
                            print('Teutonic Knight: ', jumlah_pengikut_2)
                            print('Total attack : ', total_attack)
                            print('Total defend : ', total_defend)
                            print('Total kemenangan : ', round(total_attack/total_defend))
                        else :
            ...
            print('Theutaes Thunder')
            print('Attack : 95, Defend : 85, Agility : 60')
            jumlah_pengikut_1 = input('How many Swordman? :')
            jumlah_pengikut_2 = input('How many Theutaes Thunder? :')
            if int(jumlah_pengikut_1) > 100 or int(jumlah_pengikut_2) > 100 :
                print('Too much soldier you can deploy!')
                return log_in()
            else :
                total_attack = jumlah_pengikut_1 * (galia_attack[0] + (0.75 * galia_agility[0])) +  jumlah_pengikut_2 * (galia_attack[1] + (0.75 * galia_agility[1]))
                print(total_attack)
                print('Enemy choosing puak...')
                choose_enemy = random.choice(puak_trav)
                print('Enemy has chosen' , choose_enemy)
            ...
            print('Teutonic Knight')
            print('Attack : 100, Defend : 100, Agility : 55')
            jumlah_pengikut_1 = input('How many Clubswinger? :')
            jumlah_pengikut_2 = input('How many Teutonic Knight? :')
            if int(banyak_tentara_1) > 100 or int(jumlah_pengikut_2) > 100 :
                print('Too much soldier you can deploy!')
                return log_in()
            else :
                total_attack = jumlah_pengikut_1 * (viking_attack[0] + (0.75 * viking_agility[0])) +  banyak_tentara_2 * (viking_attack[1] + (0.75 * viking_agility[1]))
                print(total_attack)
                print('Enemy choosing puak...')
                choose_enemy = random.choice(puak_trav)
                print('Enemy has chosen' , choose_enemy)
...
#Create New Username: rizfat
#Create New Password: 10
# NEW ACCOUNT CREATED
#Login to Your Acoount: rizfat
#Your Password?: 10
#status_login = active
