...
#Create New Username: dhamar
#Create New Password: pintudua
# NEW ACCOUNT CREATED
#Login to Your Acoount: dhamar
#Your Password?: pintudua
#status_login = active
