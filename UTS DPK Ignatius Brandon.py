...
print('Ketik Masuk_Arena() untuk mulai permainan')
#Login
def Masuk_Arena() :
...
#pilih puak
    if id_2 == id_1 and password_2 == password_1 :
        ...
        if choose_puak == puak_trav[0] :
            ...
            banyak_pasukan_1 = input('How many Imperians? :')
            banyak_pasukan_2 = input('How many Equites Cesaeris? :')
            if int(banyak_pasukan_1) > 100 or int(banyak_pasukan_2) > 100 :
                print('Too much soldier you can deploy!')
                return Masuk_Arena()
            else :
                total_attack = banyak_pasukan_1 * (roma_attack[0] + (0.75 * roma_agility[0])) +  banyak_pasukan_2 * (roma_attack[1] + (0.75 * roma_agility[1]))
                print(total_attack)
                ...
                if choose_enemy == puak_trav[0] :
                    ...
                    if serang == 'SERANG' :
                        ...
                        if pemenang > 0 :
                            ...
                            print('Puak : Romans')
                            print('TROOPS')
                            print('Imperian : ', banyak_pasukan_1)
                            print('Equites Cecaris : ', banyak_pasukan_2)
                    ...
                    if serang == 'SERANG' :
                        ...
                        if pemenang > 0 :
                            ...
                            print('Puak : Galia')
                            print('TROOPS')
                            print('Swordman : ', banyak_pasukan_1)
                            print('Theutaes Thunder: ', banyak_pasukan_2)
                            print('Total attack : ', total_attack)
                            print('Total defend : ', total_defend)
                            print('Total kemenangan : ', round(total_attack/total_defend))
                        else :
                    ...
                    if serang == 'SERANG' :
                        ...
                        if pemenang > 0 :
                            ...
                            print('Puak : Vikings')
                            print('TROOPS')
                            print('Clubswinger : ', banyak_pasukan_1)
                            print('Teutonic Knight: ', banyak_pasukan_2)
                            print('Total attack : ', total_attack)
                            print('Total defend : ', total_defend)
                            print('Total kemenangan : ', round(total_attack/total_defend))
                        else :
            ...
            print('Theutaes Thunder')
            print('Attack : 95, Defend : 85, Agility : 60')
            banyak_pasukan_1 = input('How many Swordman? :')
            banyak_pasukan_2 = input('How many Theutaes Thunder? :')
            if int(banyak_pasukan_1) > 100 or int(banyak_pasukan_2) > 100 :
                print('Too much soldier you can deploy!')
                return Masuk_Arena()
            else :
                total_attack = banyak_pasukan_1 * (galia_attack[0] + (0.75 * galia_agility[0])) +  banyak_pasukan_2 * (galia_attack[1] + (0.75 * galia_agility[1]))
                print(total_attack)
                print('Enemy choosing puak...')
                choose_enemy = random.choice(puak_trav)
                print('Enemy has chosen' , choose_enemy)
            ...
            print('Teutonic Knight')
            print('Attack : 100, Defend : 100, Agility : 55')
            banyak_pasukan_1 = input('How many Clubswinger? :')
            banyak_pasukan_2 = input('How many Teutonic Knight? :')
            if int(banyak_pasukan_1) > 100 or int(banyak_pasukan_2) > 100 :
                print('Too much soldier you can deploy!')
                return Masuk_Arena()
            else :
                total_attack = banyak_pasukan_1 * (viking_attack[0] + (0.75 * viking_agility[0])) +  banyak_pasukan_2 * (viking_attack[1] + (0.75 * viking_agility[1]))
                print(total_attack)
                print('Enemy choosing puak...')
                choose_enemy = random.choice(puak_trav)
                print('Enemy has chosen' , choose_enemy)
...
#Create New Username: STRAZX
#Create New Password: Ignatius
# NEW ACCOUNT CREATED
#Login to Your Acoount: STRAZX
#Your Password?: Ignatius
#status_login = active
