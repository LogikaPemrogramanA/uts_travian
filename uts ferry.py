...
print('Ketik ayoo_main() untuk mulai permainan')
#Login
def ayoo main() :
...
#pilih puak
    if id_2 == id_1 and password_2 == password_1 :
        ...
        if choose_puak == puak_trav[0] :
            ...
            banyak_pasukan = input('How many Imperians? :')
            ...
            if int(banyak_pasukan_1) > 100 or int(banyak_pasukan_2) > 100 :
                ...
                total_attack = banyak_pasukan_1 * (viking_attack[0] + (0.75 * viking_agility[0])) +  banyak_pasukana_2 * (viking_attack[1] + (0.75 * viking_agility[1]))
                print(total_attack)
                print('Enemy choosing puak...')
                choose_enemy = random.choice(puak_trav)
                print('Enemy has chosen' , choose_enemy)
...
#Create New Username: ferry
#Create New Password: fela
# NEW ACCOUNT CREATED
#Login to Your Acoount: ferry
#Your Password?: fela
#status_login = active
